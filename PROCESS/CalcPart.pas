...
uses MAIN, Math, DivUtils, formulas, CustomFormulas, HeaderTrafos, 
...
begin
    ...
    try
      ...
      ThreadCount := Min(GUI.UpDownThread.Position, CalcR.Bottom - CalcR.Top + 1);
    ...
    begin
      ...
      begin
        ...
        try
          ...
          CalcPartThread[x - 1].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
