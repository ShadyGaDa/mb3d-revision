...
uses Windows, SysUtils, Graphics, jpeg, TypeDefinitions, pngimage,
...
uses MAIN, ImageProcess, Clipbrd, DivUtils, Math, CustomFormulas, HeaderTrafos,
     Animation, AniPreviewWindow, Interpolation, Tiling,
     Math3D, Forms, Maps, Undo, Vcl.Themes, StrUtils, Types;
//FormulaGUI , NavGUI
...
begin
    ...
    begin
      ...
      ChangeFName(GUI.SaveDialog_L_1, s);{LIGHT}
      Caption := s;
    end;
end;
      ...
      begin
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                PTHeaderCustomAddon(PCFAddon).Formulas[i].iFnr := 20; //GUI.ExternFormulaNr(CustomFname);
              end;
            end;
          end;
        end   //not alt
        ...
        begin
          ...
          begin
            ...
            PTHeaderCustomAddon(PCFAddon).Formulas[0].iFnr := 20;//GUI.ExternFormulaNr(CustomFname);
          end;
        end
        else
        begin
        ...
        0, 10:  begin
         ...
         5, 8:  begin   //Box
          ...
          begin
            ...
            begin
              Formulas[0].iFnr := 20; //GUI.ExternFormulaNr(CustomFname);
