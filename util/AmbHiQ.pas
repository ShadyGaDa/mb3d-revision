...
uses Math, MAIN, Math3D, DivUtils, ImageProcess, SysUtils, Forms;
...
begin
  ...
  try
    ...
    until ymin = 0;
    ThreadCount := Min(GUI.UpDownThread.Position, RowCount);
    ...
    Result := True;
    if ((Header.bCalcAmbShadowAutomatic and 12) <> 8) or (GUI.SSAORiteration = 1) then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          try
            ...
            4: begin
                 ...
                 ascThreadR[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
            ...
            5: begin
                 ...
                 ascThreadRT0[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
            ...
            6: begin
                 ...
                 ascThreadPano[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
            ...
            7: begin
                 ...
                 ascThreadT0Pano[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
            ...
            8: begin
                 ...
                 ascThreadRPano[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
            ...
            9: begin
                 ...
                 ascThreadRT0Pano[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
           ...
           10: begin
                 ...
                 ascThreadVideo[x].Priority        := cTPrio[GUI.ComboBoxThread.ItemIndex];
        ...
        repeat
          ...
          GUI.ProgressBar1.Position := ASCparameter.aYBlockStart +
    ...
    SetLength(ATlevelHiQ, 0);
    SetLength(ATmaxArrHiQ, 0);
    GUI.OutMessage('Ambshadow calculation aborted.');
  end;
end;
