...
uses Math, MAIN, HeaderTrafos, DivUtils, PaintThread, Calc;
//LightGUI
  ...
  begin
    ...
    begin
      ...
      try
        ...
        BlockCalcThread[x - 1].Priority := cTPrio[GUI.ComboBoxThread.ItemIndex];
...
var PCTS: TPCalcThreadStats;
    ...
    CalcRect: TRect;
begin
    PCTS := @GUI.MCalcThreadStats;
    PSLstart := @GUI.siLight5[0];
    CalcRect := GUI.GetCalcRect;
    if CalcBlockyT(@GUI.MHeader, @GUI.HeaderLightVals, PCTS,
                   PSLstart, GUI.mSLoffset, mFSIstart, mFSIoffset, CalcRect) then
    begin
