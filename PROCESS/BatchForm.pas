...
var x: Integer;
begin
    GUI.OpenDialog_M_1.Options := GUI.OpenDialog_M_1.Options + [ofAllowMultiSelect];
    if GUI.OpenDialog_M_1.Execute then
    begin
...
begin
    ...
    begin
      ...
      ListView1.PopupMenu := PopupMenuBatchRen;
    end;
end;
