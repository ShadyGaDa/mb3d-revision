...
uses Animation, DivUtils, MAIN, TypeDefinitions,
...
begin
    ...
    begin
      ...
      begin
        ...
        if CheckBox8.Checked then GUI.PutLightFInHeader(AnimationForm.KeyFrames[j].HeaderParas);{LIGHT}
        ...
        begin   //HS settings
          ...
          PH.HSmaxLengthMultiplier := StrToFloatK(PostProForm.Edit_P_5.Text);
        ...
        begin
          ...
          PH.bPlanarOptic := GUI.RadioGroup_M_2.ItemIndex;
        end;
