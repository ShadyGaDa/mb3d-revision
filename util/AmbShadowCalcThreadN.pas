...
uses Math, MAIN, DivUtils, ImageProcess, SysUtils, Forms;
...
begin
  try
    ...
    if Result < za then GUI.OutMessage('Only using ' + IntToStr(Result) +
...
begin
    ...
    if Result < 1 then Exit;
    if Result < x2 then GUI.OutMessage('Only using ' + IntToStr(Result) +
