...
type
  TColorForm = class(TForm)
    ...
    Shape30: TShape;
    Label5: TLabel;
    TrackBarEx1: TrackBarEx.TTrackBarEx;
    CheckBox3: TCheckBox;
    Shape31: TShape;
...
begin
    ...
    GUI.ColorFormCreated := True;{LIGHT}
end;
...
begin
    ...
    begin
      ...
      DrawXindex := X;
      GUI.DrawInOutside := RadioGroup1.ItemIndex;
      GUI.DrawColSIndex := {Clamp01S}(X / Image1.Width);
      RepaintImage(PLight, False);
    end;
end;
