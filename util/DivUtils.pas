...
uses SysUtils, Math, formulas, Forms, HeaderTrafos, MAIN, Graphics, Maps;
...
begin
    ...
    if Length(s) > 24 then GUI.OutMessage('The filename must be 24 or less characters long to be saved.');
end;
